#ifndef _FACE_MAP_SURF_OBJ_HPP_
#define _FACE_MAP_SURF_OBJ_HPP_
 ...
 */
class FaceMapSurfObj: public GeoObject {
private:
    FaceMapSurf* _bdsurf;            /// manifold surface object
...
public:
     ...
     * Constructor method
     */
  FaceMapSurfObj(FaceMapSurf* surf, int lvl, int gen, int alt, //char* texFile, 
	    int renderctrl=RENDER_SURF,int surfctrl=SURF_NONE, int activevert=-1): 
            ...
            {
                selectionMode = false;
                //_texture = new Texture(surf,lvl,texFile);
            }
    /**
